...
export default defineWorkspace([
  ...
  { test: { name: 'integration', fileParallelism: false, maxWorkers: 1, include: ['server/tests/integration/**/*.test.ts', 'client/tests/integration/**/*.test.ts', 'tests/integration/**/*.test.ts'] } },
